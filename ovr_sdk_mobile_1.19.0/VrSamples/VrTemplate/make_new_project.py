...
shutil.copytree('Android/jni', '../%s/Android/jni' % proj_dir)
shutil.copy2('Android/AndroidManifest.xml', '../%s/Android/' % proj_dir)
shutil.copy2('Android/build.bat', '../%s/Android/' % proj_dir)
shutil.copy2('Android/build.py', '../%s/Android/' % proj_dir)
shutil.copy2('Android/build.gradle', '../%s/Android/' % proj_dir)
shutil.copy2('Android/settings.gradle', '../%s/Android/' % proj_dir)
...
replace_in_file("../%s/Android/AndroidManifest.xml" % proj_dir, "vrtemplate", proj_dir.lower())
replace_in_file("../%s/Android/build.bat" % proj_dir, "vrtemplate", proj_dir)
replace_in_file("../%s/Android/build.py" % proj_dir, "vrtemplate", proj_dir)
...
replace_in_file("../%s/Android/build.gradle" % proj_dir, "vrtemplate", proj_dir.lower())
replace_in_file("../%s/Android/build.gradle" % proj_dir, "VrTemplate", proj_dir)
replace_in_file("../%s/Android/settings.gradle" % proj_dir, "VrTemplate", proj_dir)
...
replace_in_file("../%s/Android/AndroidManifest.xml" % proj_dir, "yourcompany", company_name)
replace_in_file("../%s/Android/build.bat" % proj_dir, "yourcompany", company_name)
replace_in_file("../%s/Android/build.py" % proj_dir, "yourcompany", company_name)
replace_in_file("../%s/Android/build.gradle" % proj_dir, "yourcompany", company_name)
...
print('Finished creating: %s' % proj_dir)
